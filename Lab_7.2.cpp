...
int main()
{
    ...
    int j;
	student a[m] = { 
	{ 1, "Бакал Софiя Вiталiївна"      , true, true, true},
	{ 2, "Бiда Дарiя Олександрiвна   "        , true, true, true},
	{ 3, "Анiкiн Дмитро Русланович"      , true, true, true},
	...
	{11, "Кадуха Володимир Сергiйович"         , true, true, false},
	{12, "Iльїн Iгор Андрiйович"   , true, false, false},
	...
	{19, "Латишенко Марiя Сергiївна"      , true, true, true},
	{20, "Кравченко Софія Ігорiвна"     , false, true, true},
